...
public class MyBatisMapperScannerConfig implements EnvironmentAware , ApplicationContextAware {
    ...
    public SqlSessionFactory sqlSessionFactoryBean(DataSource dataSource) {
        ...
        bean.setConfigLocation(new ClassPathResource("/mybatis/service/mapper.xml"));
        //bean.setConfigLocation(new PathMatchingResourcePatternResolver().getResource("/mybatis/service/mapper.xml"));
