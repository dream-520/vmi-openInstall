...
/**
 * 遇见轮播图跳转app内部页面(android和ios)
 * @author liuman
 *
 */
public enum NavitePageEnum {
	...
	//此处添加映射关系
	static {
		for(NavitePageEnum v : NavitePageEnum.values()) {
	...
	private NavitePageEnum(String code,String androidPage , String iosPage ,String desc , String param) {
		this.code = code;
	...
	public static String getDescByCode(String code) {
		...
		for (NavitePageEnum refer : NavitePageEnum.values())
