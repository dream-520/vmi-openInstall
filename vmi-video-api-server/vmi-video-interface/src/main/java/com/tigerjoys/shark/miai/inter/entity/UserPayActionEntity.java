...
/**
 * 数据库中  用户支付记录[t_user_pay_action] 表对应的实体类
 * @author yangjunming
 * @Date 2019-11-26 11:25:26
 *
 */
@Table(name="t_user_pay_action")
public class UserPayActionEntity extends BaseEntity implements Serializable {
