...
/**
 * 数据库中  小红花账户流水[t_red_flower_account_log] 表对应的实体类
 * @author yangjunming
 * @Date 2019-08-09 16:26:44
 *
 */
@Table(name="t_red_flower_account_log")
public class RedFlowerAccountLogEntity extends BaseEntity implements Serializable {
	 ...
	 * 充值或者消费的小红花
	 */
	@Column(name="flower",nullable=false,jdbcType=JdbcType.BIGINT,comment="充值或者消费的小红花")
	private Long flower;
	
	/**
	 * 账户剩余小红花
	 */
	@Column(name="balance",nullable=false,jdbcType=JdbcType.BIGINT,comment="账户剩余小红花")
