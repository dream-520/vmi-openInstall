...
/**
 * 数据库中  充钻自定义手机型号表[t_recharge_custom_mobile] 表对应的实体类
 * @author mouzhanpeng
 * @Date 2018-08-03 14:04:38
 *
 */
@Table(name="t_recharge_custom_mobile")
public class RechargeCustomMobileEntity extends BaseEntity implements Serializable {
