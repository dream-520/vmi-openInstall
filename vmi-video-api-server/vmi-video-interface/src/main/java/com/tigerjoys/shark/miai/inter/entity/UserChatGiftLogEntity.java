...
/**
 * 数据库中  礼物消费记录[t_user_chat_gift_log] 表对应的实体类
 * @author yangjunming
 * @Date 2019-10-30 18:21:58
 *
 */
@Table(name="t_user_chat_gift_log")
public class UserChatGiftLogEntity extends BaseEntity implements Serializable {
