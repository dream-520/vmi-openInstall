...
/**
 * 数据库中  [t_v_page] 表对应的实体类
 * @author shiming
 * @Date 2019-03-06 17:19:41
 *
 */
@Table(name="t_v_page")
public class VPageEntity extends BaseEntity implements Serializable {
	 ...
	 * level
	 */
	@Column(name="level",nullable=true,jdbcType=JdbcType.SMALLINT,comment="level")
	private Integer level;
	
	/**
	 * pages
	 */
	@Column(name="pages",nullable=true,jdbcType=JdbcType.SMALLINT,comment="pages")
