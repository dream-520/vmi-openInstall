...
/**
 * 数据库中  root用户登录注册信息记录表[t_root_user_reg_log] 表对应的实体类
 * @author lipeng
 * @Date 2019-09-11 14:54:35
 *
 */
@Table(name="t_root_user_reg_log")
public class RootUserRegLogEntity extends BaseEntity implements Serializable {
