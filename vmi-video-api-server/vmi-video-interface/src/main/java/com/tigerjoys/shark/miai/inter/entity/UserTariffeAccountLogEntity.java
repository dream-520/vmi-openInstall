...
/**
 * 数据库中  用户话费账户流水[t_user_tariffe_account_log] 表对应的实体类
 * @author lipeng
 * @Date 2019-12-10 14:00:50
 *
 */
@Table(name="t_user_tariffe_account_log")
public class UserTariffeAccountLogEntity extends BaseEntity implements Serializable {
	 ...
	 * 充值或者消费的话费
	 */
	@Column(name="tariffe",nullable=false,jdbcType=JdbcType.BIGINT,comment="充值或者消费的话费")
	private Long tariffe;
	
	/**
	 * 账户剩余话费
	 */
	@Column(name="balance",nullable=false,jdbcType=JdbcType.BIGINT,comment="账户剩余话费")
	...
	public Long getTariffe() {
		return tariffe;
	}

	public void setTariffe(Long tariffe) {
