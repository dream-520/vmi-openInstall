...
/**
 * 数据库中  用户聊天送礼物数量统计表[t_user_chat_gift_statistics_fake] 表对应的实体类
 * @author lipeng
 * @Date 2019-07-17 16:50:03
 *
 */
@Table(name="t_user_chat_gift_statistics_fake")
public class UserChatGiftStatisticsFakeEntity extends BaseEntity implements Serializable {
