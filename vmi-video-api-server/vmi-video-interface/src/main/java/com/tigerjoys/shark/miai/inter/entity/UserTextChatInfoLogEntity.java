...
/**
 * 数据库中  用户文字聊天详细记录[t_user_text_chat_info_log] 表对应的实体类
 * @author yangjunming
 * @Date 2019-12-17 17:13:31
 *
 */
@Table(name="t_user_text_chat_info_log")
public class UserTextChatInfoLogEntity extends BaseEntity implements Serializable {
