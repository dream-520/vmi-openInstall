...
/**
 * 数据库中  礼物消费记录[t_user_chat_gift_log_fake] 表对应的实体类
 * @author lipeng
 * @Date 2019-07-17 16:12:28
 *
 */
@Table(name="t_user_chat_gift_log_fake")
public class UserChatGiftLogFakeEntity extends BaseEntity implements Serializable {
