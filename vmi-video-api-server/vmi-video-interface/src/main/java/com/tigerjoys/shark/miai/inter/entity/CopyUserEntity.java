...
/**
 * 数据库中  用户基础表[t_copy_user] 表对应的实体类
 * @author lipeng
 * @Date 2019-12-17 15:58:25
 *
 */
@Table(name="t_copy_user")
public class CopyUserEntity extends BaseEntity implements Serializable {
	...
	/**
	 * 推送渠道标识 -1 无推送 0默认小米  1华为 2 vivo
	 */
	@Column(name="push_channel",nullable=true,jdbcType=JdbcType.TINYINT,comment="推送渠道标识 -1 无推送 0默认小米  1华为 2 vivo")
