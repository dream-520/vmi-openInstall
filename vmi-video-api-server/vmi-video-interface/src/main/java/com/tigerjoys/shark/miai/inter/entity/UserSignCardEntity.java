...
/**
 * 数据库中  用户补签卡账户[t_user_sign_card] 表对应的实体类
 * @author lipeng
 * @Date 2018-12-06 11:49:35
 *
 */
@Table(name="t_user_sign_card")
public class UserSignCardEntity extends BaseEntity implements Serializable {
	 ...
	 * 补签卡数量
	 */
	@Column(name="card_count",nullable=false,jdbcType=JdbcType.INTEGER,comment="补签卡数量")
