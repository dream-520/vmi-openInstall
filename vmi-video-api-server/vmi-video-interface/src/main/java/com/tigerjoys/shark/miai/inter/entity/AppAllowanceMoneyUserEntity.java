...
/**
 * 数据库中  app补助用户记录表[t_app_allowance_money_user] 表对应的实体类
 * @author shiming
 * @Date 2019-07-11 17:47:23
 *
 */
@Table(name="t_app_allowance_money_user")
public class AppAllowanceMoneyUserEntity extends BaseEntity implements Serializable {
