...
/**
 * 数据库中  充值订单表[t_recharge_order] 表对应的实体类
 * @author yangjunming
 * @Date 2019-08-15 19:34:21
 *
 */
...
public class RechargeOrderEntity extends BaseEntity implements Serializable {
	 ...
	 * 钻石商品ID
	 */
	@Column(name="price_id",nullable=false,jdbcType=JdbcType.BIGINT,comment="钻石商品ID")
	private Long price_id;
	
	/**
	 * 钻石商品价格(分)
	 */
	@Column(name="price",nullable=false,jdbcType=JdbcType.INTEGER,comment="钻石商品价格(分)")
	 ...
	 * 0 送钻  1 送钱
	 */
	@Column(name="donor_type",nullable=true,jdbcType=JdbcType.TINYINT,comment="0 送钻  1 送钱")
