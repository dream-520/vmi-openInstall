...
/**
 * 数据库中  用户头像审核拒绝记录表[t_user_photo_refuse_log] 表对应的实体类
 * @author lipeng
 * @Date 2019-12-14 16:36:00
 *
 */
@Table(name="t_user_photo_refuse_log")
public class UserPhotoRefuseLogEntity extends BaseEntity implements Serializable {
