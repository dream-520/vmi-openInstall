...
/**
 * 数据库中  能量充值统计表[t_statistics_user_energy_recharge] 表对应的实体类
 * @author mouzhanpeng
 * @Date 2018-08-23 16:55:29
 *
 */
@Table(name="t_statistics_user_energy_recharge")
public class StatisticsUserEnergyRechargeEntity extends BaseEntity implements Serializable {
