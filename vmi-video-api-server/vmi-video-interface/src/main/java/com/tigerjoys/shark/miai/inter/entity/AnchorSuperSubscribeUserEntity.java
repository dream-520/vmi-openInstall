...
/**
 * 数据库中  用户一键预约表[t_anchor_super_subscribe_user] 表对应的实体类
 * @author shiming
 * @Date 2019-11-18 11:22:47
 *
 */
@Table(name="t_anchor_super_subscribe_user")
public class AnchorSuperSubscribeUserEntity extends BaseEntity implements Serializable {
	 ...
	 * 预约次数
	 */
	@Column(name="times",nullable=true,jdbcType=JdbcType.INTEGER,comment="预约次数")
