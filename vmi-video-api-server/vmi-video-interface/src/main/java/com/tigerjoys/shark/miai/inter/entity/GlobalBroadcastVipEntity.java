...
/**
 * 数据库中  全局广播[t_global_broadcast_vip] 表对应的实体类
 * @author shiming
 * @Date 2019-12-03 18:10:56
 *
 */
@Table(name="t_global_broadcast_vip")
public class GlobalBroadcastVipEntity extends BaseEntity implements Serializable {
