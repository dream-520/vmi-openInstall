...
/**
 * 数据库中  [t_download_statistics] 表对应的实体类
 * @author yangjunming
 * @Date 2018-05-03 17:54:59
 *
 */
@Table(name="t_download_statistics")
public class DownloadStatisticsEntity extends BaseEntity implements Serializable {
