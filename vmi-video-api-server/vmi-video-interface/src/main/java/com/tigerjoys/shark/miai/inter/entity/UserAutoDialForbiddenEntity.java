...
/**
 * 数据库中  用户自动拨打禁用Id[t_user_auto_dial_forbidden] 表对应的实体类
 * @author yangjunming
 * @Date 2020-02-26 15:14:00
 *
 */
@Table(name="t_user_auto_dial_forbidden")
public class UserAutoDialForbiddenEntity extends BaseEntity implements Serializable {
