...
/**
 * 数据库中  虚假来电弹窗[t_app_sham_dail] 表对应的实体类
 * @author shiming
 * @Date 2019-09-17 17:02:19
 *
 */
@Table(name="t_app_sham_dail")
public class AppShamDailEntity extends BaseEntity implements Serializable {
	 ...
	 * 诱导主播
	 */
	@Column(name="vuserid",nullable=true,jdbcType=JdbcType.BIGINT,comment="诱导主播")
