...
@Service(VivoPushMessageEnum.com_ydwx_yoyo)
public class VivoPushMessageServiceImpl1 extends AbstractVivoPushService {
	...
	private final int impl = VivoPushMessageEnum.vivo_com_ydwx_yoyo.getImpl();
