 ...
 * @since JDK 1.8.0 
 */
public enum VchatRoomIncomeFalgEnum {
	no_income(0,"初始无收益"), //无收益
	not_recorded(1,"待结算"),
	anchor_no_income(2,"无收益"),
	...
	static {
		for(VchatRoomIncomeFalgEnum refer : VchatRoomIncomeFalgEnum.values()) {
			err_desc.put(refer.getCode(), refer.getDesc());
		}
	}
	
	private VchatRoomIncomeFalgEnum(int code, String desc) {
		this.code = code;
		this.desc = desc;
	}
