...
public class SignatureUtils {
     ...
     * @return
     */
    public static boolean verifySignature(HttpServletRequest request, String secretid, String secretkey, String businessid) throws UnsupportedEncodingException {
