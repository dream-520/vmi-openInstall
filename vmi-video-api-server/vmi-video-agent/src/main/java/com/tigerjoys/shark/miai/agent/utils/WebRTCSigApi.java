...
public class WebRTCSigApi {
    ...
    public static void main(String[] args) {
        int sdkappid = 1400137811;   //腾讯云云通信sdkappid
        int roomid = 1234;           //音视频房间号roomid
        String userid = "junming";  //用户名userid
...
//        api.setPublicKey(new String(publicKey));
        ...
        String privateKey="MIGHAgEAMBMGByqGSM49AgEGCCqGSM49AwEHBG0wawIBAQQgpurhN6S1kw4bvbMkwpfweAluVR8tfV8Slor5kh7dsg2hRANCAARO8Aa3pOwoa1Z2jyF3Dx1cJZa+XV6la94flMpkjMy2alo0iVDQougnM0BOdjh4gOv/kjyOqmnCCCNO0oP1RqvR";
        String publicKey="MFkwEwYHKoZIzj0CAQYIKoZIzj0DAQcDQgAETvAGt6TsKGtWdo8hdw8dXCWWvl1epWveH5TKZIzMtmpaNIlQ0KLoJzNATnY4eIDr/5I8jqppwggjTtKD9Uar0Q==";
        api.setPrivateKey(privateKey);
        api.setPublicKey(publicKey);
        
        //生成userSig
        String userSig = api.genUserSig(userid, 60*60*24);
        
        //生成privateMapKey
        String privateMapKey = api.genPrivateMapKey(userid, roomid, 60*60*24);
