 ...
 *
 */
@Service("androidXiaomiPush")
public class AndroidXiaoMiPushServiceImpl extends AbstractMiPushService{

	private static final Log logger = LogFactory.getLog(AndroidXiaoMiPushServiceImpl.class);

	private static final String androidAccountSecret = PushConstant.android_xiaomi_accountSecret;
	private static final String androidAccountPackageName = PushConstant.android_xiaomi_accountPackageName;
	...
	protected Message buildMessage(String msg, long sec, String msgType, int notifyid) {
		...
		logger.info("androidXiaomiPush notifyid=" + notifyid);
