...
@Service(VivoPushMessageEnum.com_ydwx_yoyo2)
public class VivoPushMessageServiceImpl3 extends AbstractVivoPushService {
	...
	private final int impl = VivoPushMessageEnum.vivo_com_ydwx_yoyo2.getImpl();
